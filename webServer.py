...
def webServer(port=13331):
  ...
  while True:
    ...
    try:
      ...
      filename = message.split()[1] #filename is going to be the message at the second block
      ...
      outputdata += b"Server: dth6589 Python Server\r\n"
      ...
      for i in f: #for line in file
        outputdata += i #append line to output
